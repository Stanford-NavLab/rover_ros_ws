...
message(STATUS "planner: 3 messages, 0 services")

set(MSG_I_FLAGS "-Iplanner:/home/navlab-nuc/rover_ros_ws/src/planner/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/navlab-nuc/rover_ros_ws/src/planner/msg/State.msg" NAME_WE)
add_custom_target(_planner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "planner" "/home/navlab-nuc/rover_ros_ws/src/planner/msg/State.msg" ""
)

get_filename_component(_filename "/home/navlab-nuc/rover_ros_ws/src/planner/msg/Control.msg" NAME_WE)
add_custom_target(_planner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "planner" "/home/navlab-nuc/rover_ros_ws/src/planner/msg/Control.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/planner)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/planner/.+/__init__.pyc?$"
  )
endif()
